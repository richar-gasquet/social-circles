            ...
            <form onSubmit={handleSubmit} className="mb-3">
              {Object.keys(formData).map((key) => {
                ...
                const placeholders = {
                  ...
                  preferred_name:
                    "Enter your preferred name if different from your first name",
                  family_circumstance:
                    "Describe any aspects of your family life that are important to you (e.g., single parent, large family)",
                  community_status:
                    "Describe your role or status in your local or professional community (e.g., community leader, active volunteer)",
                  interests:
                    "List your hobbies or interests (e.g., reading, hiking, painting)",
                  personal_identity:
                    "Describe elements of your personal identity that are important to you (e.g., cultural, professional, personal beliefs)",
                };
                return (
                  <div
                    style={{ marginTop: "4%" }}
                  ...
                  >
                    ...
                    {isOtherField && (
                      <input
                        ...
                        onBlur={handleBlur}
                        className={`form-control ${
                          formErrors[`${key}Other`] ? "is-invalid" : ""
                        }`}
          ...
          <div className={styles.profileRow}>
            <div className={`col-md-6 ${styles.userLeft}`}>
              <div className={styles.profilePicWrap}>
                <img
                  src={userData.picture ? userData.picture : logo}
                  alt="Profile Photo"
              ...
              <div className={styles.buttonWrap}>
                <button onClick={toggleEdit} className={styles.toggleEdit}>
                  Update Information
                </button>
              </div>
              <div className={styles.buttonWrap}>
                <button onClick={handleLogout} className={styles.handleLogout}>
                  Log Out
                </button>
              </div>
              <div className={styles.buttonWrap}>
                <button onClick={handleDelete} className={styles.handleDelete}>
                  Delete Account
                </button>
              </div>
            </div>
            <div
              className={`col-md-6 ${styles.userInfo}`}
              style={{ outline: "#F5EDED solid 10px", borderRadius: "1%" }}
            >
