...
export const useFormLogic = (initialUserData) => {
  ...
  return { formData, setFormData, formErrors, isLoading, editMode, handleBlur, handleChange, handleSubmit, handleCancel, handleDelete, toggleEdit, confirmModal, handleDynamicSelectChange, showConfirmModal, handleConfirm, userData, welcomeModal };
};
