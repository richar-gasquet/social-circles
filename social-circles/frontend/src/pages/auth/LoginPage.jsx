    ...
    <>
      ...
      <div className={`${styles.loginContainer}`}>
        <div className={`${styles.welcomeContainer}`}>
          <h1>Welcome to Social Circles</h1>
          <p style={{fontSize: '18px', fontWeight: '500'}}>Sign in to continue access, to get started with your new community</p>
        </div>
        <div className={`${styles.loginFormContainer}`}>
          <h2 className={`${styles.signinText}`}>Sign In</h2>
          <button className={`${styles.gsimaterialbutton}`} style={{width: '200px'}} onClick={handleLogin}>
