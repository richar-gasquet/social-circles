      ...
      try {
          ...
          if (request.ok) {
            ...
            setAlert({
              ...
              text: "The attendees for this event's emails could not be fetched.."
          });
          }
        } catch (error) {
          setAlert({
                ...
                text: "We could not connect to the server while fetching the event emails."
          });
        }
    } else {
      setAlert({
  ...
  return (
    <Modal show={props.isShown} onHide={props.handleClose} backdrop="static">
      <Modal.Header className={`${styles.modalHeader}`}>
        <Modal.Title className={`${styles.modalTitle}`}>Email Attendees for {props.eventName} </Modal.Title>
      </Modal.Header>
      <Modal.Body>
        {alert && (
          <AlertBox
